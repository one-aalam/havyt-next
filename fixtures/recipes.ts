...
export const RECIPES = [
  {
    ...
    description: 'These Chicken Flautas are filled with chicken, salsa, and cheese and baked in the oven until crispy. Your whole family will love this easy, delicious recipe.',
    imageUrl:
